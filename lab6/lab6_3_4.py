...
texture_on = True
texture_iterator = 0
image_table = ["kapłon.tga", "tekstura.tga", "tekstura2.tga"]
...
def startup():
    global texture_iterator, image_table
...
def texture_change():
    global texture_iterator

    texture_iterator += 1

    if texture_iterator == 3:
        texture_iterator = 0

    image = Image.open(image_table[texture_iterator])
...
def keyboard_key_callback(window, key, scancode, action, mods):
    global texture_on, texture_iterator
