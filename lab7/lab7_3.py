...
def startup():
    ...
    vertex_colors = numpy.zeros(vertex_positions.size)

    for i in range(vertex_positions.size):
        vertex_colors[i] = random.uniform(0.00, 1.00)
    ...
    vertex_buffer_2 = glGenBuffers(1)
...
def render(time):
    ...
    M_matrix = glm.rotate(glm.mat4(1.0), time, glm.vec3(1.0, 1.0, 1.0))
